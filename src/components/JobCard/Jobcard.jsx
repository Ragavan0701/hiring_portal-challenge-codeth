...
//                         <p key={skills} className="text-gray-500 py-1 px-2 rounded-md border border-black">{skills}</p>
//                     ))}
//                 </div>
//             </div>
//             <div className='flex items-center gap-4'>
//                 <p className='text-gray-500'>Posted {diff >1? `${diff} days`: `${diff} day`}  ago</p>
...
//       <div className="flex flex-col md:flex-row justify-between items-center px-6 py-4 bg-zinc-200 rounded-md border-black shadow-lg hover:border-blue-500 hover:translate-y-1 hover:scale-103">
//         <div className="flex flex-col items-start gap-3">
//           <h1 className='text-lg md:text-xl lg:text-2xl font-semibold'>{props.title} - {props.company}</h1>
//           <p className='text-xs md:text-sm lg:text-base'>{props.type} &#x2022; {props.experience} &#x2022; {props.location}</p>
